const initializeGDeveloppeJs = require('../../Binaries/embuild/GDeveloppe.js/libGD.js');
...
describe('libGD.js', function () {
  let gd = null;
  beforeAll((done) =>
    initializeGDeveloppeJs().then((module) => {
      gd = module;
      done();
    })
  );
  ...
  describe('gd.Project', function () {
    ...
    it('can store loading screen setup', function () {
      project.getLoadingScreen().showGDeveloppeSplash(true);
      expect(project.getLoadingScreen().isGDeveloppeSplashShown()).toBe(true);
      project.getLoadingScreen().showGDeveloppeSplash(false);
      expect(project.getLoadingScreen().isGDeveloppeSplashShown()).toBe(false);
    });
