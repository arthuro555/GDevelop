...
const outputFile = '../src/Version/VersionMetadata.ts';
...
const writeFile = object => {
  return new Promise((resolve, reject) => {
    const content = [
      ...
      `// prettier-ignore`,
      `export default ${JSON.stringify(object, null, 2)} as const;`,
      ``,
    ].join('\n');
...
writeFile({
  ...
  () => console.info('✅ src/Version/VersionMetadata.ts properly generated.'),
  err => console.error('❌ Error while src/Version/VersionMetadata.ts', err)
);
