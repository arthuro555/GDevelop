...
export default React.forwardRef<ParameterFieldProps, ParameterFieldInterface>(
  function RiveResourceField(props, ref) {
    ...
    if (!props.resourceManagementProps || !props.project) {
      console.error(
        'Missing project or resourceManagementProps for RiveResourceField'
      );
      return null;
    }
    ...
    return (
      <ResourceSelector
        ...
        floatingLabelText={<Trans>Choose the Rive canvas file to use</Trans>}
