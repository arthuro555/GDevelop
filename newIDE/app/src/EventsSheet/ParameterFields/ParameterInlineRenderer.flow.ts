...
export type ParameterInlineRendererProps = {
 ...
 InvalidParameterValue: (arg1: InvalidParameterValueProps) => React.ReactElement,
 ...
 */
export type ParameterInlineRenderer = (arg1: ParameterInlineRendererProps) => React.ReactElement;
