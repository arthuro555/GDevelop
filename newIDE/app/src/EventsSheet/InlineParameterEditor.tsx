...
const InlineParameterEditor = ({
  ...
  const [parameterMetadata, setParameterMetadata] = React.useState<
    gd.ParameterMetadata | null | undefined
  >(null);
  const [instructionMetadata, setInstructionMetadata] = React.useState<
