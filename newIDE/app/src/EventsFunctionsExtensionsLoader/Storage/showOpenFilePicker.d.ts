...
declare global {
  ...
  var showOpenFilePicker = (
    /** An object containing options that control the file picker's behavior. */ options?: ShowOpenFilePickerOptions
// @ts-expect-error - TS1005 - '(' expected.
  ) => Promise<FileSystemFileHandle[]>;

  /** Displays a file picker that allows a user to save a file. */
  var showSaveFilePicker = (
    /** An object containing options that control the file picker's behavior. */ options?: ShowSaveFilePickerOptions
// @ts-expect-error - TS1005 - '(' expected.
  ) => Promise<FileSystemFileHandle[]>;
}
