  ...
  _loadProjectEventsFunctionsExtensions(project: ?gdProject): Promise<void> {
    ...
    this._lastLoadPromise = lastLoadPromise
      ...
      .catch((eventsFunctionsExtensionsError: Error) => {
        ...
        showErrorBox({
          message: i18n._(
            t`An error has occured during functions generation. If GDeveloppe is installed, verify that nothing is preventing GDeveloppe from writing on disk. If you're running GDeveloppe online, verify your internet connection and refresh functions from the Project Manager.`
          ),
