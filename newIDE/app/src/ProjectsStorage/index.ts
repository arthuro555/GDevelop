...
export type ResourcesActionsMenuBuilder = (arg1: ResourcesActionsProps) => Array<MenuItemTemplate>;
...
export type StorageProviderOperations = {
  ...
  onEnsureCanAccessResources?: (project: gdProject, fileMetadata: FileMetadata) => Promise<void>,
  // Project saving:
  onSaveProject?: (
    project: gdProject,
    fileMetadata: FileMetadata,
  ...
  // Project auto saving:
  onAutoSaveProject?: (project: gdProject, fileMetadata: FileMetadata) => Promise<void>,
  getAutoSaveCreationDate?: (fileMetadata: FileMetadata, compareLastModified: boolean) => Promise<number | null | undefined>,
...
export type StorageProvider = {
  ...
  getFileMetadataFromAppArguments?: (arg1: AppArguments) => FileMetadata | null | undefined,
  getProjectLocation?: (
    arg1: {
      projectName: string,
      saveAsLocation: SaveAsLocation | null | undefined,
