...
type LayersListBodyProps = {
  ...
  onLayerRenamed: () => void;
  onEditEffects: (layer?: gd.Layer | null | undefined) => void;
  onEdit: (layer?: gd.Layer | null | undefined) => void;
  width: number;
};

const getEffectsCount = (platform: gd.Platform, layer: gd.Layer) => {
...
type Props = {
  ...
  onSelectLayer: (arg1: string) => void;
  layersContainer: gd.Layout;
  onEditLayerEffects: (layer?: gd.Layer | null | undefined) => void;
  onEditLayer: (layer?: gd.Layer | null | undefined) => void;
  onRemoveLayer: (layerName: string, cb: (done: boolean) => void) => void;
  onLayerRenamed: () => void;
  onCreateLayer: () => void;
  unsavedChanges?: UnsavedChanges | null | undefined;
...
const hasLightingLayer = (layout: gd.Layout) => {
...
const LayersList = React.forwardRef<LayersListInterface, Props>(
  (props, ref) => {
    const forceUpdate = useForceUpdate();
