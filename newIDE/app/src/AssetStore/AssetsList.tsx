...
const AssetsList = React.forwardRef<AssetsListInterface, Props>(
  (
    {
      assetShortHeaders,
      onOpenDetails,
    ...
    const [authorPublicProfile, setAuthorPublicProfile] = React.useState<
      UserPublicProfile | null | undefined
    >(null);
    ...
    const scrollView = React.useRef<ScrollViewInterface | null | undefined>(
      null
    );
    ...
    const publicAssetPackAuthors: Array<Author> | null | undefined =
      React.useMemo(
        () =>
    ...
    const publicAssetPackLicenses: Array<License> | null | undefined =
      React.useMemo(
        () =>
