...
const getObjectAssetResourcesByName = (
  ...
  [key: string]: any /*(serialized gd.Resource)*/;
} => {
...
export const AssetDetails = React.forwardRef<AssetDetailsInterface, Props>(
  (
    {
      onTagSelection,
      assetShortHeader,
    ...
    const [selectedAnimationName, setSelectedAnimationName] = React.useState<
