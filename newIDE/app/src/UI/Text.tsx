...
type TextSize = 'bold-title' | 'title' | 'section-title' | 'block-title' | 'sub-title' | 'body' | 'body2' | 'body-small';
...
type Interface = Record<any, any>;

const getVariantFromSize = (size?: TextSize | null) => {
  switch (size) {
    case 'bold-title':
      return 'h1';
    case 'title':
...
const getTextColorFromColor = (color?: TextColor | null) => {
  switch (color) {
    case 'error':
      return 'error';
    case 'primary':
