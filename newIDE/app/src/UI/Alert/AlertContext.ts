...
export type ShowConfirmDeleteFunction = (
  arg1: ShowConfirmDeleteDialogOptions
) => Promise<boolean>;
...
export type ConfirmState = {
  ...
  showConfirmDeleteDialog: (
    arg1: ShowConfirmDeleteDialogOptionsWithCallback
  ) => void;
  showYesNoCancelDialog: (
    arg1: ShowYesNoCancelDialogOptionsWithCallback
  ) => void;
};
