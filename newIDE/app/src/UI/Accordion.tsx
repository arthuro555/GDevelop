...
type AccordionActionsProps = {
  actions: Array<React.ReactNode>,
  secondaryActions?: Array<React.ReactNode>
};
 ...
 */
// @ts-expect-error - TS2749 - 'MUIAccordion' refers to a value, but is being used as a type here. Did you mean 'typeof MUIAccordion'?
export const Accordion = React.forwardRef<AccordionProps, MUIAccordion>((props, ref) => {
