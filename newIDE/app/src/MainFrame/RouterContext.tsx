...
'guided-lesson' | 'subscription' | 'games-dashboard' | // For compatibility when there was only asset packs.
'asset-store' | 'store'; // New way of opening the store.
type RouteKey = 'initial-dialog' | 'game-id' | 'games-dashboard-tab' | 'asset-pack' | 'game-template' | 'tutorial-id';
