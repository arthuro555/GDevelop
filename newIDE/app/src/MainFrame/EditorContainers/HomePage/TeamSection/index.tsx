...
import { TeamGroup, User } from '../../../../Utils/GDevelopServices/User';
...
const TeamSection = React.forwardRef<TeamSectionInterface, Props>(
  (
    ...
    const [selectedUser, setSelectedUser] = React.useState<
      User | null | undefined
    >(null);
    const [selectedUserProjects, setSelectedUserProjects] = React.useState<
      Array<CloudProjectWithUserAccessInfo> | null | undefined
    >(null);
