...
// @ts-expect-error - TS6142 - Module '.' was resolved to '/home/arthuro555/code/GDevelop/newIDE/app/src/PropertiesEditor/index.tsx', but '--jsx' is not set.
import { Schema, Instance } from '.';
import { ResourceKind } from '../ResourcesList/ResourceSource';
// @ts-expect-error - TS6142 - Module '.' was resolved to '/home/arthuro555/code/GDevelop/newIDE/app/src/PropertiesEditor/index.tsx', but '--jsx' is not set.
import { Field } from '.';
// @ts-expect-error - TS6142 - Module './MeasurementUnitDocumentation' was resolved to '/home/arthuro555/code/GDevelop/newIDE/app/src/PropertiesEditor/MeasurementUnitDocumentation.tsx', but '--jsx' is not set.
...
// @ts-expect-error - TS7006 - Parameter 'i' implicitly has an 'any' type.
  mapFor(0, propertyNames.size(), i => {
    ...
    let field: Field | null | undefined = null;
