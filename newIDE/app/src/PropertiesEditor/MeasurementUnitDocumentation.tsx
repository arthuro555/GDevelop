...
// Strings are used instead of gd.MeasurementUnit
// because the C++ instances would be dead when the component is rendered.
//
// The gd.MeasurementUnit instances are only living during their iteration on
...
// referenced by the gd.MeasurementUnit instance has been reused and it displays
// wrong values.
type Props = {
  label: string;
  description: string;
