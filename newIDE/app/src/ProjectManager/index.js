          ...
          <div style={styles.container}>
            ...
            <List style={styles.list}>
              ...
              <ProjectStructureItem
                ...
                leftIcon={
                  <Badge
                    badgeContent={updateableExtensions.length}
                    color="secondary"
                    max={9}
                  >
                    <ListIcon
                  ...
                  filterProjectItemsList(
                    ...
                    .concat(
                      <SearchListItem
                        ...
                        primaryText={
                          <Plural
                            value={updateableExtensions.length}
                            zero="Install new extensions from the gallery"
                            one="An update for an extension is available!"
                            other={`Updates for ${
                              updateableExtensions.length
