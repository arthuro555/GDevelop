...
import { Exporter, ExporterSection, ExporterSubSection } from '.';
...
type PublishHomeProps = {
  ...
  onChooseSubSection: (
    subSection?: ExporterSubSection | null | undefined
  ) => void;
...
const PublishHome = ({
  ...
  const [builds, setBuilds] = React.useState<Array<Build> | null | undefined>(
    null
  );
