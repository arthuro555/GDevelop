...
export const CreateAuthKeySteps = ({ authenticatedUser }: Props) => {
  ...
  const [authKeyFile, setAuthKeyFile] = React.useState<File | null | undefined>(
    null
  );
  ...
  const [lastUploadedApiKey, setLastUploadedApiKey] = React.useState<
    string | null | undefined
  >(null);
  const [isAuthKeyLoading, setIsAuthKeyLoading] = React.useState(false);
  const [authKeyError, setAuthKeyError] = React.useState<
