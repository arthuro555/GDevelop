...
export type PreviewOptions = {
  project: gdProject,
  layout: gdLayout,
  externalLayout: gdExternalLayout | null | undefined,
...
export type PreviewLauncherInterface = {
  ...
  readonly getPreviewDebuggerServer: () => PreviewDebuggerServer | null | undefined
};
 ...
 */
export type PreviewLauncherComponent = Flow.AbstractComponent<PreviewLauncherProps, PreviewLauncherInterface>;
