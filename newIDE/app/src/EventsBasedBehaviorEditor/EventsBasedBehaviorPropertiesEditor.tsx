...
type Props = {
  ...
  properties: gd.PropertiesContainer;
...
const getExtraInfoArray = (property: gd.NamedPropertyDescriptor) => {
...
export default function EventsBasedBehaviorPropertiesEditor(props: Props) {
  ...
  const draggedProperty = React.useRef<
    gd.NamedPropertyDescriptor | null | undefined
  >(null);
  ...
  const copyProperty = React.useCallback(
    (property: gd.NamedPropertyDescriptor) => {
  ...
  const pastePropertiesBefore = React.useCallback(
    async (property: gd.NamedPropertyDescriptor) => {
  ...
  const movePropertyBefore = React.useCallback(
    (targetProperty: gd.NamedPropertyDescriptor) => {
  ...
  const setHidden = React.useCallback(
    (property: gd.NamedPropertyDescriptor, enable: boolean) => {
              ...
              <ScrollView ref={scrollView}>
                <Line>
                  <Column noMargin expand>
                    {mapVector(
                      properties,
                      (property: gd.NamedPropertyDescriptor, i: number) => {
                        const propertyRef =
