...
export type GameMetrics = {
  ...
  sessions:
    | {
        ...
        d0SessionsDurationTotal: number | null | undefined;
      }
    | null
    | undefined;
  players:
...
export const getGameMetrics = async (
  ...
  gameId: string,
  dayIsoDate: string
): Promise<GameMetrics | null | undefined> => {
