...
import { GDeveloppeBuildApi } from './ApiConfigs';
...
export const buildElectron = (
  ...
  return getAuthorizationHeader()
    .then(authorizationHeader =>
      axios.post(
        `${GDeveloppeBuildApi.baseUrl}/build?userId=${encodeURIComponent(
          userId
...
export const getBuild = (
  ...
  return getAuthorizationHeader()
    .then(authorizationHeader =>
      axios.get(`${GDeveloppeBuildApi.baseUrl}/build/${buildId}`, {
        params: {
          userId,
        },
        headers: {
...
export const getBuilds = (
  ...
  return getAuthorizationHeader()
    .then(authorizationHeader =>
      axios.get(`${GDeveloppeBuildApi.baseUrl}/build`, {
        params: {
          userId,
        },
        headers: {
