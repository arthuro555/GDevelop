...
import { GDeveloppeAssetApi } from './ApiConfigs';
...
export const isCompatibleWithAsset = (
  ideVersion: string,
  assetHeader: { GDeveloppeVersion: string }
) =>
  assetHeader.GDeveloppeVersion
    ? semverSatisfies(ideVersion, assetHeader.GDeveloppeVersion, {
...
export const listAllAssets = (): Promise<AllAssets> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/asset`)
...
export const getAsset = (
  ...
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/asset/${assetShortHeader.id}`)
    .then(response => response.data)
    .then(({ assetUrl }) => {
      if (!assetUrl) {
...
export const listAllExamples = (): Promise<AllExamples> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/example`)
    .then(response => response.data)
...
export const getExample = (
  ...
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/example/${exampleShortHeader.id}`)
    .then(response => response.data)
    .then(({ exampleUrl }) => {
      if (!exampleUrl) {
        throw new Error('Unexpected response from the example endpoint.');
...
export const listAllResources = (): Promise<AllResources> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/resource`)
    .then(response => response.data)
...
export const listAllAuthors = (): Promise<Array<Author>> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/author`)
    .then(response => response.data)
    .then(({ authorsUrl }) => {
      if (!authorsUrl)
...
export const listAllLicenses = (): Promise<Array<License>> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/license`)
    .then(response => response.data)
    .then(({ licensesUrl }) => {
      if (!licensesUrl)
