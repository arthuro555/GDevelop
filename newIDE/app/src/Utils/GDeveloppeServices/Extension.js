 ...
 * (which is kept in the API for compatibility with older GDeveloppe versions).
 */
...
export const isCompatibleWithExtension = (
  ...
  extensionShortHeader.GDeveloppeVersion
    ? semverSatisfies(ideVersion, extensionShortHeader.GDeveloppeVersion, {
...
export const getExtensionsRegistry = (): Promise<ExtensionsRegistry> => {
  return axios
    .get(`${GDeveloppeAssetApi.baseUrl}/extension`)
