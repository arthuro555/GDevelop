...
function InAppTutorialStepDisplayer({
  ...
  const [elementToHighlight, setElementToHighlight] = React.useState<
    HTMLElement | null | undefined
  >(null);
  const [elementWithId, setElementWithId] = React.useState<
    HTMLElement | null | undefined
  >(null);
  const [hideBehindOtherDialog, setHideBehindOtherDialog] =
    React.useState<boolean>(false);
  const [assistantImage, setAssistantImage] = React.useState<
