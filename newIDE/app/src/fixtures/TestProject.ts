...
export type TestProject = {|
  project: gd.Project,
  shapePainterObjectConfiguration: gd.ObjectConfiguration,
  ...
  group2: gd.ObjectGroup,
  group4WithLongsNames: gd.ObjectGroup,
  testLayoutInstance1: gd.InitialInstance,
  testLayoutInstance2: gd.InitialInstance,
  testLayoutInstance3: gd.InitialInstance,
  testInstruction: gd.Instruction,
  testExternalEvents1: gd.ExternalEvents,
  testExternalEvents2: gd.ExternalEvents,
  emptyLayout: gd.Layout,
  emptyEventsList: gd.EventsList,
  testEventsFunction: gd.EventsFunction,
  testEventsFunctionsExtension: gd.EventsFunctionsExtension,
  testSerializedEvents: Object,
  testSerializedEventsWithLotsOfObjects: Object,
  testEventsBasedBehavior: gd.EventsBasedBehavior,
  testEmptyEventsBasedBehavior: gd.EventsBasedBehavior,
  testBehaviorEventsFunction: gd.EventsFunction,
  testBehaviorLifecycleEventsFunction: gd.EventsFunction,
  testEventsBasedObject: gd.EventsBasedObject,
  testObjectEventsFunction: gd.EventsFunction,
  layerWithEffects: gd.Layer,
  layerWith3DEffects: gd.Layer,
  ...
  unknownRelationalOperatorParameterMetadata: gd.ParameterMetadata,
  emptyObjectsContainer: gd.ObjectsContainer,
|};
*/
