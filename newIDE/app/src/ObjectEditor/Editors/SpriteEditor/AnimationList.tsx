...
// @ts-expect-error - TS6142 - Module './SpritesList' was resolved to '/home/arthuro555/code/GDevelop/newIDE/app/src/ObjectEditor/Editors/SpriteEditor/SpritesList.tsx', but '--jsx' is not set.
} from './SpritesList';
...
type AnimationListProps = {
  ...
  scrollView: {
    current: ScrollViewInterface | null | undefined
  },
  onCreateMatchingSpriteCollisionMask: () => Promise<void>
};

const AnimationList = React.forwardRef<AnimationListProps, AnimationListInterface>((
  {
// @ts-expect-error - TS2339 - Property 'animations' does not exist on type 'AnimationListInterface'.
    animations,
// @ts-expect-error - TS2339 - Property 'project' does not exist on type 'AnimationListInterface'.
    project,
// @ts-expect-error - TS2339 - Property 'layout' does not exist on type 'AnimationListInterface'.
    layout,
// @ts-expect-error - TS2339 - Property 'object' does not exist on type 'AnimationListInterface'.
    object,
// @ts-expect-error - TS2339 - Property 'objectName' does not exist on type 'AnimationListInterface'.
    objectName,
// @ts-expect-error - TS2339 - Property 'resourceManagementProps' does not exist on type 'AnimationListInterface'.
    resourceManagementProps,
// @ts-expect-error - TS2339 - Property 'onSizeUpdated' does not exist on type 'AnimationListInterface'.
    onSizeUpdated,
// @ts-expect-error - TS2339 - Property 'onObjectUpdated' does not exist on type 'AnimationListInterface'.
    onObjectUpdated,
// @ts-expect-error - TS2339 - Property 'isAnimationListLocked' does not exist on type 'AnimationListInterface'.
    isAnimationListLocked = false,
// @ts-expect-error - TS2339 - Property 'scrollView' does not exist on type 'AnimationListInterface'.
    scrollView,
// @ts-expect-error - TS2339 - Property 'onCreateMatchingSpriteCollisionMask' does not exist on type 'AnimationListInterface'.
...
// @ts-expect-error - TS2740 - Type '{ forceUpdate: () => void; addAnimation: () => void; }' is missing the following properties from type 'AnimationListProps': project, objectName, resourceManagementProps, onSizeUpdated, and 3 more.
...
// @ts-expect-error - TS7006 - Parameter 'animationId' implicitly has an 'any' type. | TS7006 - Parameter 'directionId' implicitly has an 'any' type. | TS7006 - Parameter 'newDirection' implicitly has an 'any' type.
...
// @ts-expect-error - TS7006 - Parameter 'directionIndex' implicitly has an 'any' type.
                                directionIndex => {
...
// @ts-expect-error - TS7006 - Parameter 'i18n' implicitly has an 'any' type.
                                        i18n,
// @ts-expect-error - TS7006 - Parameter 'ResourceExternalEditor' implicitly has an 'any' type.
                                        ResourceExternalEditor,
// @ts-expect-error - TS7006 - Parameter 'direction' implicitly has an 'any' type.
                                        direction
                                      ) =>
                                        editDirectionWith(
                                          i18n,
...
// @ts-expect-error - TS7006 - Parameter 'newDirection' implicitly has an 'any' type.
