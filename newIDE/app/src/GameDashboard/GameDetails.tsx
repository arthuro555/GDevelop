...
const GameDetails = ({
  ...
  const [gameUnregisterErrorText, setGameUnregisterErrorText] = React.useState<
  ...
  const [publicGame, setPublicGame] = React.useState<
    PublicGame | null | undefined
  >(null);
  const [publicGameError, setPublicGameError] = React.useState<
